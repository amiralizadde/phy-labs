...
const ProductDetails = ({ params }: { params: { slug: string } }) => {
  ...
  useEffect(() => {
    ...
    console.log("productData[0]->", productData.length && productData[0].name);
  }, [productData]);


  const getProductDetail = async () => {
    await fetch(`/${locale}/api/products/getProductOne`, {
      method: "POST",
      headers: {
      ...
      <div className="ps-3 xs:px-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 child:me-auto sm:child:ms-auto child:mb-auto sm:child:me-0 gap-y-5 lg:child:mx-auto ">
          ...
          <div className="p-5">
            <div>
              <p className="font-semibold text-sm">
                {productData.length > 0 && productData[0].fullName}
              </p>
          ...
          <div className="flex flex-col items-center justify-center py-5 px-2 border border-black w-[300px] ">
            <div className="text-xl font-medium">price :{productData.length > 0 && (Number(productData[0].price)).toLocaleString()} T</div>
            ...
            {tabInfo === "Technical" && (
              <div>
                ...
                <p>
                  ...
                  Eum // ea ab voluptates, nam mollitia magnam odio
                  reprehenderit // excepturi dignissimos ratione repellendus
                  labore pariatur iste // voluptatum deleniti possimus debitis,
                  fuga ipsam. Vitae quod // incidunt autem iusto mollitia
                  necessitatibus quidem ratione, // id quos quia quas deserunt
                  veritatis dolorem aperiam // cupiditate totam error? Quae aut
                  natus fugit nulla tempora // asperiores qui, est voluptate.
                  Harum quod magni quidem // deserunt molestias eum sint alias
                  modi laborum, dolore, // deleniti ipsum neque. Dolore quis
                  velit sed nostrum et saepe // explicabo provident cumque
                  consequatur minus. Dolor, suscipit // inventore. Iste ratione
                  velit officiis porro voluptatum // sapiente possimus corporis.
                  Cum alias eveniet repudiandae? // Doloremque animi deleniti
                  dolor id, quos iste, quis, minus et // ipsam porro dolores!
                  Dolore fuga doloremque velit! // Perferendis, atque ratione.
                  Laboriosam similique impedit // nostrum nemo, rem optio
                  tempore? Officiis voluptatibus // temporibus iure perspiciatis
                  impedit, laudantium mollitia // officia ipsam eaque neque
                  harum obcaecati eveniet commodi quis // doloribus voluptatum?
                  Sunt, exercitationem corrupti ab rem // dolorem neque
                  architecto voluptates explicabo modi facilis // sapiente
                  debitis blanditiis molestiae! Deleniti, sit fuga. // Mollitia
                  doloremque doloribus dolor praesentium dolore, id // nemo
                  itaque placeat eius. Nisi enim nulla nihil dicta animi //
                  alias consequatur, adipisci commodi atque eos, cum veniam //
                  velit accusamus distinctio repellat praesentium! Molestiae //
                  natus minus ex magnam quisquam aperiam quia reprehenderit //
                  iure! Ut! Tempora enim vitae ex totam. Rerum velit provident
                  ...
                  maiores reprehenderit consequuntur? Ducimus sequi inventore //
                  voluptate eaque veritatis dolorem qui fugit, eius dolor. Error
                  // suscipit unde animi ipsum temporibus voluptate, odit
                  eveniet // cumque aliquam eius sequi quos sit ea tempora
                  cupiditate // fugiat. Accusantium eum sint atque a. Illum est
                  maxime quam // deserunt quod? Tenetur tempora ut fuga
                  obcaecati vero, dolor // autem, odit molestiae nobis, cum
                  harum! Veritatis praesentium // recusandae tempora quia,
                  reiciendis dolores alias at, // voluptatem soluta quae nihil
                  cum, laudantium maxime // doloremque! Aut culpa omnis error
                  delectus reiciendis rerum //{" "}
                </p>
              </div>
            )}
